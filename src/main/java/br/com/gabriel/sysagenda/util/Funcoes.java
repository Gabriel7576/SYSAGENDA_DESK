...
public class Funcoes {
	...
	public static boolean showMensagem(String msn) {

		Object[] options = { "Sim, sim, claro...", "Não, cara." };

		return JOptionPane.showOptionDialog(null, msn, "Atenção", JOptionPane.YES_NO_OPTION,
